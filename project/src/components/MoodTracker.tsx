...
const MoodTracker: React.FC<MoodTrackerProps> = ({ onMoodAdded }) => {
  ...
  const moods = [
    { id: 'sad' as const, label: 'Sad', icon: Frown, color: 'text-red-500', bgColor: 'bg-red-50', emoji: '😢' },
    { id: 'normal' as const, label: 'Normal', icon: Meh, color: 'text-yellow-500', bgColor: 'bg-yellow-50', emoji: '😐' },
    { id: 'happy' as const, label: 'Happy', icon: Smile, color: 'text-green-500', bgColor: 'bg-green-50', emoji: '😊' },
    { id: 'excited' as const, label: 'Excited', icon: Laugh, color: 'text-orange-500', bgColor: 'bg-orange-50', emoji: '🤩' },
  ];
